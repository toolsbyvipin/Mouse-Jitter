# Mouse Jitter
## RUN Cmd AS ADMINSTRATOR ON VICTIM'S PC AND PASTE 
```bash
#Run Cmd as adminstration on target's OS and paste this to use jitter 
...
# Mouse Freezer 
```bash
#Run cmd as admistration on Victim's computer and paste 
